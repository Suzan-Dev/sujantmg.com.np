...
images:
  [
    '/static/images/blogs/2.an-intro-to-object-oriented-programming-in-javascript/image1.png',
    '/static/images/blogs/2.an-intro-to-object-oriented-programming-in-javascript/image2.png',
    '/static/images/blogs/2.an-intro-to-object-oriented-programming-in-javascript/image3.png',
    '/static/images/blogs/2.an-intro-to-object-oriented-programming-in-javascript/image4.png',
    '/static/images/blogs/2.an-intro-to-object-oriented-programming-in-javascript/image5.png',
  ]
layout: PostLayout
authors: ['default']
---

![JavaScript and Object-Oriented Programming](/static/images/blogs/2.an-intro-to-object-oriented-programming-in-javascript/image1.png)
...
![Object](/static/images/blogs/2.an-intro-to-object-oriented-programming-in-javascript/image2.png)
...
![Class](/static/images/blogs/2.an-intro-to-object-oriented-programming-in-javascript/image3.png)
...
![Encapsulation](/static/images/blogs/2.an-intro-to-object-oriented-programming-in-javascript/image4.png)
...
![Inheritance](/static/images/blogs/2.an-intro-to-object-oriented-programming-in-javascript/image5.png)
