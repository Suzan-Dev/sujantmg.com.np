---
title: Here are the 5 Things I Liked About Vue.js
date: '2021-09-01'
tags: ['Vue.js']
draft: false
summary: In this post, you’ll learn the five great things of Vue.js progressive JS framework than other JS libraries and frameworks.
images: ['/static/images/blogs/5.here-are-the-5-things-i-liked-about-vuejs/image1.jpg']
layout: PostLayout
authors: ['default']
---

![Learn Vue.js](/static/images/blogs/5.here-are-the-5-things-i-liked-about-vuejs/image1.jpg)
...
But I was for sure going to learn one of these: [React](https://reactjs.org/), [Vue](https://vuejs.org/) or [Angular](https://angular.io/).
...
Now, After having sound knowledge of React, I wanted to learn a **framework** and choosed to learn **Vue.js**.
In the future, I'll definitely make an article on other **evolving libraries/frameworks**.
...
_This is all the opinions based on my research. so, It shouldn't offend anyone and you can disagree with me. Hope you liked the article._
