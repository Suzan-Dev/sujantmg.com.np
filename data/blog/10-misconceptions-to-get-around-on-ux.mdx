...
## The infinite scroll is a benchmark in designing a good browsing experience
...
## Everything must necessarily be accessible from the homepage
...
## The UX designer is the new webmaster of the 21st century
...
## To be simple, the design must be minimalist
...
## The more choices a user has, the more satisfied they will be
...
## To please a user, you need an original design
...
## You don't have to meet the users, we're like them
...
## The UX designer must make my website intuitive
