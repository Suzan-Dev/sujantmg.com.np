...
images: ['/static/images/blogs/9.efficient-redux-development-with-redux-toolkit/image1.jpg']
layout: PostLayout
authors: ['default']
---

![Redux Toolkit Logo](/static/images/blogs/9.efficient-redux-development-with-redux-toolkit/image1.jpg)
...
In the next article, I'll be covering about **RTK Query (RTKQ)**.
