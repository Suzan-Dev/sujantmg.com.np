...
images: ['/static/images/blogs/1.react-throttle-debounce/image1.jpg']
layout: PostLayout
authors: ['default']
---

![react-throttle-debounce](/static/images/blogs/1.react-throttle-debounce/image1.jpg)
...
[Try the demo](https://codesandbox.io/s/no-debouncing-forked-xkovk?file=/src/index.js)
...
[Try the demo](https://codesandbox.io/s/use-callback-debouncing-forked-01oz8?file=/src/index.js)
...
Open the [demo](https://codesandbox.io/s/use-callback-debouncing-forked-01oz8?file=/src/index.js) and type a query: you’ll see that the list is filtered with a delay of `300ms` after the last typing: which brings a softer and better user experience.
...
[Try the demo](https://codesandbox.io/s/use-memo-debouncing-forked-2p9ou?file=/src/index.js)
...
If you open the [demo](https://codesandbox.io/s/use-memo-debouncing-forked-2p9ou?file=/src/index.js), you’d see that typing into the input field is still debounced.
