...
At that time, I felt that I was not growing with the team members and left that job to take some time-off and learn on my own.
...
my knowledge because I'm also a self-taught and learned to code through blogs & videos. But later, I felt like I was reading others blog and
copying many of it to my own blogs. That was not my actual motive behind to start writing blogs so, I stopped.
...
from all of them is _Generics_. It helped me to reduce my code for types by making it reuseable. I learned more of **React** and
looked into **Solid** and **Remix** but didn't tried to learn any other framework/library. The new React docs is great.
...
I spend time reading countless blogs on **Nodejs** topics that was new to me.
...
I still have some interest on **Blockchain** so, I could also learn it.
If new technologies pop out, I'll take a look into them.
