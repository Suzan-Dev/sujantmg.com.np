const projectsData = [
  ...
  {
    title: 'EzBazaar',
    description: `My first client project where I built the frontend part of the e-commerce app,
  ...
  {
    title: 'Meal Finder',
    description: `A small personal project built to learn vanilla javascript along with
